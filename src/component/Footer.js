    ...
    return(
        <footer  className="tc-l w-100 ">
          <div className="flex justify-center">
            ...
            <a className="link black-80 dim inline-flex items-center ma2 tc br2 pa2" href="https://github.com/yuwen-c/worldtime-luxon" target="_blank" title="GitHub" rel="noopener noreferrer">
