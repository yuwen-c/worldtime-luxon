...
const Footer = () => {
    return(
        <footer  className="tc-l bg-center  w-100">
          <div className="w-100 ph3">
            
            <a className="link black-80 dim inline-flex items-center ma2 tc br2 pa2" href="https://github.com/yuwen-c" target="_blank" title="GitHub">
              ...
              <span className="f6 ml3 pr2">yuwen-c</span>
            </a>
            ...
            <a className="link black-80 dim inline-flex items-center ma2 tc br2 pa2" href="mailto: http://codepen.io" title="Gmail">
              ...
              <span className="f6 ml3 pr2">Mail me</span>
            </a>
